...
For the hard cases — spanning table cells, LaTeX, fenced code, chat transcripts, footnotes — the raw outputs of three clippers are on the [comparison page](/compare), generated by a script you can rerun.
